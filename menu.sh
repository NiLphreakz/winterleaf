...
echo -e "  \e[$text Version Name         : XRAY x NOOBZVPN"
...
echo -e " \e[$line╘════════════════════════════════════════════════════════════╛\e[m"
echo -e " \e[$text V2ray   Vless   VlessXtls   Trojan-Tcp   Tojan-Go    \e[0m "    
echo -e " \e[$below    $vmess       $vless        $xtls           $trtls           $trgo \e[0m "
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   " \e[$back_text                     \e[30m[\e[$box XRAY/NOOBZ MENU\e[30m ]\e[1m                   \e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$number (•1)\e[m \e[$below XRAY VMESS & VLESS\e[m"
echo -e   "  \e[$number (•2)\e[m \e[$below TROJAN XRAY & GO\e[m"
echo -e   "  \e[$number (•3)\e[m \e[$below NOOBZVPN\e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   " \e[$back_text                        \e[30m[\e[$box MAIN MENU\e[30m ]\e[1m                       \e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$number (•4)\e[m \e[$below CHANGE PORT\e[m"      
echo -e   "  \e[$number (•5)\e[m \e[$below CFWARP MENU\e[m"          
echo -e   "  \e[$number (•6)\e[m \e[$below SYSTEM MENU\e[m"            
echo -e   "  \e[$number (•7)\e[m \e[$below MENU THEMES\e[m"     
echo -e   "  \e[$number (•8)\e[m \e[$below CHECK RUNNING\e[m"
echo -e   "  \e[$number (•9)\e[m \e[$below CLEAR LOG VPS\e[m"
echo -e   "  \e[$number (•10)\e[m \e[$below INFO ALL PORT\e[m"
echo -e   "  \e[$number (•11)\e[m \e[$below REBOOT VPS\e[m"   
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
